...
public partial class DtMenuData
{
    ...
    public void InitMenuData()
    {
        ...
        // Major Units
        dtmenudata.Add(DtMenuItem.MakeMenuItem(0, 0, "MAJOR_UNITS", null, null, DtMenuItem.MenuType.ExpandableRow));
        dtmenudata.Add(DtMenuItem.MakeMenuItem(1, 0, "MAJOR_UNITS_INVOICING", null, typeof(TabPage1), DtMenuItem.MenuType.Row));
        dtmenudata.Add(DtMenuItem.MakeMenuItem(2, 0, "MUSALES_LIST", null, typeof(TabPage1), DtMenuItem.MenuType.Row));
        dtmenudata.Add(DtMenuItem.MakeMenuItem(3, 0, "ORDERING", null, typeof(TabPage1), DtMenuItem.MenuType.Row));
        dtmenudata.Add(DtMenuItem.MakeMenuItem(4, 0, "MURECEIVINGWITHPO", null, typeof(TabPage1), DtMenuItem.MenuType.Row));
        dtmenudata.Add(DtMenuItem.MakeMenuItem(5, 0, "MAJORUNITMANAGEMENT_GROUP", null, typeof(TabPage1), DtMenuItem.MenuType.Row));
        dtmenudata.Add(DtMenuItem.MakeMenuItem(6, 5, "MUINVENTORY_LIST", null, typeof(TabPage1), DtMenuItem.MenuType.Row));
        dtmenudata.Add(DtMenuItem.MakeMenuItem(7, 5, "MU_RECEIVE_TRANSFER", null, typeof(TabPage1), DtMenuItem.MenuType.Row));
        dtmenudata.Add(DtMenuItem.MakeMenuItem(8, 5, "MODELMANAGEMENT_LIST", null, typeof(TabPage1), DtMenuItem.MenuType.Row));
        dtmenudata.Add(DtMenuItem.MakeMenuItem(9, 5, "MU_CATEGORY_LIST", null, typeof(TabPage1), DtMenuItem.MenuType.Row));
        dtmenudata.Add(DtMenuItem.MakeMenuItem(10, 5, "BUNDLE_LIST", null, typeof(TabPage1), DtMenuItem.MenuType.Row));
        dtmenudata.Add(DtMenuItem.MakeMenuItem(11, 5, "INCENTIVE_LIST", null, typeof(TabPage1), DtMenuItem.MenuType.Row));
        dtmenudata.Add(DtMenuItem.MakeMenuItem(12, 5, "NEWFISALE", null, typeof(TabPage1), DtMenuItem.MenuType.Row));
        dtmenudata.Add(DtMenuItem.MakeMenuItem(20, 0, "MAJORUNITREPORTS", null, typeof(TabPage1), DtMenuItem.MenuType.Row));

        // parts
        dtmenudata.Add(DtMenuItem.MakeMenuItem(100, 100, "GROUP_PARTS", null, null, DtMenuItem.MenuType.ExpandableRow));
        dtmenudata.Add(DtMenuItem.MakeMenuItem(101, 100, "INVOICE", null, typeof(TabPage1), DtMenuItem.MenuType.Row));
        dtmenudata.Add(DtMenuItem.MakeMenuItem(102, 100, "PART_INVOICE_LIST", null, typeof(TabPage1), DtMenuItem.MenuType.Row));
        dtmenudata.Add(DtMenuItem.MakeMenuItem(103, 100, "PARTSORDERING", null, typeof(TabPage1), DtMenuItem.MenuType.Row));
        dtmenudata.Add(DtMenuItem.MakeMenuItem(104, 100, "PARTSRECEIVING", null, typeof(TabPage1), DtMenuItem.MenuType.Row));
        dtmenudata.Add(DtMenuItem.MakeMenuItem(105, 100, "PARTSMANAGEMENT_GROUP", null, null, DtMenuItem.MenuType.Header));
        dtmenudata.Add(DtMenuItem.MakeMenuItem(106, 105, "PARTSINVENTORY_LIST", null, typeof(TabPage1), DtMenuItem.MenuType.Row));
        dtmenudata.Add(DtMenuItem.MakeMenuItem(107, 105, "PART_TRANSFER_IN", null, typeof(TabPage1), DtMenuItem.MenuType.Row));
        dtmenudata.Add(DtMenuItem.MakeMenuItem(108, 105, "TRANSFEROUTOFINVENTORY", null, typeof(TabPage1), DtMenuItem.MenuType.Row));
        dtmenudata.Add(DtMenuItem.MakeMenuItem(109, 105, "PARTSVENDORRETURN", null, typeof(TabPage1), DtMenuItem.MenuType.Row));
        dtmenudata.Add(DtMenuItem.MakeMenuItem(110, 105, "PHYSICALINVENTORY", null, typeof(TabPage1), DtMenuItem.MenuType.Row));
        dtmenudata.Add(DtMenuItem.MakeMenuItem(111, 105, "PART_CATEGORY_LIST", null, typeof(TabPage1), DtMenuItem.MenuType.Row));
        dtmenudata.Add(DtMenuItem.MakeMenuItem(112, 105, "SEASONAL_ORDERING", null, typeof(TabPage1), DtMenuItem.MenuType.Row));
        dtmenudata.Add(DtMenuItem.MakeMenuItem(113, 105, "PROFITMARGIN", null, typeof(TabPage1), DtMenuItem.MenuType.Row));
        dtmenudata.Add(DtMenuItem.MakeMenuItem(120, 100, "PARTSREPORTS", null, typeof(TabPage1), DtMenuItem.MenuType.Row));
